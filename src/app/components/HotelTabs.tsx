  ...
  return (
    ...
    >
      <div className="w-full max-w-lg rounded-2xl bg-white/95 backdrop-blur shadow-2xl overflow-hidden border border-white/20">
        {/* Title / Branding */}
        <div className="p-6 text-center border-b border-gray-700 bg-gray-800/70">
          <h1 className="text-3xl font-black tracking-tight text-gray-100">CASA</h1>
          <p className="text-xs font-bold uppercase tracking-wider text-gray-400 mt-1">Smart Hotel Management Suite</p>
        </div>

        {/* Tab selector */}
        <div className="flex bg-gray-800 p-1 m-4 rounded-xl">
          <button
            type="button"
            ...
            {currentLinks.map((link) => (
              <Link
                ...
                className={`flex items-center justify-center p-4 rounded-xl font-bold text-center border text-sm transition-all duration-200 ${
                  activeTab === 'standard'
                    ? 'border-gray-600 bg-gray-700/70 text-gray-100 hover:bg-gray-600 hover:text-white hover:border-gray-500'
                    : 'border-gray-600 bg-gray-700/70 text-gray-100 hover:bg-gray-600 hover:text-white hover:border-gray-500'
                }`}
              >
                {link.name}
            ...
            <div className="mt-6 pt-5 border-t border-gray-100">
              <div className="bg-gray-800 rounded-xl p-4 border border-gray-700 text-left">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-xs font-bold uppercase tracking-wider text-gray-100">Install CASA App</h3>
                ...
                <button
                  ...
                  className="mt-3 flex items-center justify-center gap-2 w-full py-2.5 px-4 rounded-lg bg-gray-600 text-white hover:bg-gray-700 active:bg-gray-800 font-bold text-xs uppercase tracking-wider transition-colors shadow-sm"
                >
                ...
                {installFeedback && (
                  <p className="mt-2 text-xs font-semibold text-gray-200 flex items-center gap-1.5 bg-gray-700/70 px-2 py-1 rounded">
