...
2. Fill in the remaining Firebase web app values from the `casa-67c3b` Firebase project settings.
3. Deploy `database.rules.json` to Realtime Database so the app can read/write `casa/standard` and `casa/platinum`.
