    ...
    <div className="flex h-full min-h-0 w-64 flex-col bg-black text-white border-r border-sidebar-border">
      <div className="p-8 flex justify-center">
        <Link href="/dashboard" className="group">
          <div className="w-20 h-20 bg-white rounded-2xl flex items-center justify-center p-2 group-hover:scale-105 transition-transform overflow-hidden shadow-2xl relative border border-gray-200">
            <Image
              src="/logo.png"
              alt="CASA Logo"
              width={80}
      ...
      <div className="shrink-0 p-4 border-t border-sidebar-border mt-auto">
        <div className="flex items-center gap-3 p-3 rounded-xl bg-gray-900/90 mb-4 border border-gray-700">
